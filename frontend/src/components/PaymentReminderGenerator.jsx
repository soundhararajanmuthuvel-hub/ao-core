      ...
      footer={
        <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            ...
            <button type="button" className="btn btn-secondary" onClick={downloadJpg} disabled={loading}>JPG</button>
            <button type="button" className="btn btn-secondary" onClick={downloadPdf} disabled={loading}>PDF</button>
            <button type="button" className="btn btn-whatsapp" onClick={sendWhatsApp} disabled={loading}>
              💬 Send WhatsApp
            </button>
          </div>
        </div>
