...
export const returnsApi = {
  ...
  orderSearch: (query) => client.get('/returns/order-search', { params: { query } }),
  approve: (id) => client.put(`/returns/${id}/approve`),
  receive: (id, data) => client.put(`/returns/${id}/receive`, data),
  processRefund: (id, data) => client.put(`/returns/${id}/process-refund`, data),
  processReplacement: (id, data) => client.put(`/returns/${id}/process-replacement`, data),
  cancel: (id, data) => client.put(`/returns/${id}/cancel`, data),
